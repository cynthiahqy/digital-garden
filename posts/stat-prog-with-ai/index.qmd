...
- [Michael Lydeamore](https://www.michaellydeamore.com/)
- [Kate Saunders](https://research.monash.edu/en/persons/kate-saunders)
...
I relied heavily on Claude Code to help me expand, populate and format the Quarto course website, group project, and lecture slides, though that workflow is a post for another time. One quick tip is to install [Posit's Quarto authoring skill](https://github.com/posit-dev/skills/tree/main#quarto).

## Course Philosophy & Design

You can read the [full course rationale](https://soda-lmu.github.io/StatProg2-2026-SoSe/syllabus.html#course-rationale) (shared with students) on the course website.
